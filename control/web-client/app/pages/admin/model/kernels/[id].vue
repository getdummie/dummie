...
interface Kernel {
  ...
  size_bytes: number
  created_at: string
  // "" while the kernel is offered; when it was withdrawn otherwise.
  soft_deleted_at: string
  // Short-lived, minted for this response. Absent on a withdrawn kernel and
...
// --- description ---
//
// The one thing about a saved kernel that can change: a note about the image,
// not part of what the name means.
