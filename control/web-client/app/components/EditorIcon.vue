...
<template>
  <svg v-if="d" v-bind="$attrs" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path :d="d" />
  </svg>
  <Code v-else v-bind="$attrs" aria-hidden="true" />
</template>
