...
// Everything dclient enforces lives in one table, `inet dclient`, which is
...
// a rule. That is what makes the policy safe against dclient itself -- the rules
// are already in the kernel, they fail closed, and a crashed client cannot open
...
// from an older build of the client.
//
