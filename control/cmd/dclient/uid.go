...
// was no privilege to drop in the first place. It runs as dclient does.
...
// for dclient, which is root, and the guest is no longer.
//
...
// kvmGroup is the group /dev/kvm is handed to when dclient has to repair the
