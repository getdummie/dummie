...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/me/tokens/{id}/revoke".format(id=quote(str(id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Revoke a personal access token
     ...
     Anything using it stops working immediately. The row stays in the list, marked revoked, so the
    credential's history is still readable.
