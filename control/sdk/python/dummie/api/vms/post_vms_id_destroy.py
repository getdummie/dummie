...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/vms/{id}/destroy".format(id=quote(str(id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Destroy a VM
     ...
     Stops the guest and deletes its disk on the host. This is the one action that frees the quota the VM
    was holding, and it cannot be undone.
